...
class AuthViewModel(application: Application) : AndroidViewModel(application) {
    companion object {
        ...
        const val FETCHING_DAMAGE_TYPES = 2
        const val FETCHING_WEAPON_PROPERTIES = 3
        const val FETCHING_WEAPONS = 4
    ...
    val waitingFor = MutableLiveData(listOf(SEARCHING_FOR_CHARACTER, FETCHING_SPELLS,
        FETCHING_DAMAGE_TYPES, FETCHING_WEAPON_PROPERTIES, FETCHING_WEAPONS))
