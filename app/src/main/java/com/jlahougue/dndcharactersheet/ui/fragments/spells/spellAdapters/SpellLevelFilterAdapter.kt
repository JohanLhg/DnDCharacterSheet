...
class SpellLevelFilterAdapter(private val listener: SpellLevelFilterListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    companion object {
        ...
        interface SpellLevelFilterListener {
